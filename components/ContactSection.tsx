...
const LINKS = [
  {
    name: "Email",
    href: "mailto:tanuj9340685860@gmail.com",
    value: "tanuj9340685860@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/tjrajpoot/",
    value: "linkedin.com",
        ...
        <div className="w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center py-20 pb-24">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              ...
              <p className="text-muted max-w-md mx-auto lg:mx-0">
                Have a project in mind or want to connect? Reach out through any channel below.
              </p>
            </motion.div>
